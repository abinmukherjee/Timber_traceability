...
In the preliminary pages, A blank page is inserted.\footnote{A blank page may be inserted after the cover page when using the twoside
...
point of alignment for each equation is specified using the ampersand symbol. One may use the online equation generator to get the latex code of required equations: \url{https://www.codecogs.com/latex/eqneditor.php} 
\begin{align}
a &= b  \\
a + e + f + g & = m + n + z \\
x + 2 & = x^{3} + 3 x^{2} + 2 x + 5
