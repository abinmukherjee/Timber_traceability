...
This uses IIIT Bhopal Report Class (iiitbhopal.cls)
and an IEEE format citation (IEEEtran.bst).  It will also generate
a cover page with the IITB logo (IIITBhopalLogo), certificate, 
declaration, and acknowledgements in standard format.
